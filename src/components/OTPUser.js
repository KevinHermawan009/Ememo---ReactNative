...
const Link_getInput = 'https://fitaccessproject.herokuapp.com/api/FitAccess/InputGenerateOTPTransaksi'
const Link_generateOTP = 'https://fitaccessproject.herokuapp.com/api/FitAccess/GenerateOTPTransaksi'
const Link_ChangeDateState = 'https://fitaccessproject.herokuapp.com/api/FitAccess/UpdateHoursBooking'

class OTPUser extends Component {
    constructor(props) {
        super(props);
        this.state = {
            lblSalesHariini: '',
...
export default connect(mapStateToProps, mapDispatchToProps)(OTPUser)