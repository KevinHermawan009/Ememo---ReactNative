...
const Link_getInput = 'https://fitaccessproject.herokuapp.com/api/FitAccess/InputGenerateOTP'
const Link_generateOTP = 'https://fitaccessproject.herokuapp.com/api/FitAccess/GenerateOTP'
const Link_ChangeDateState = 'https://fitaccessproject.herokuapp.com/api/FitAccess/UpdateHoursBooking'
const Link_BindCust = 'https://fitaccessproject.herokuapp.com/api/FitAccess/BindCustomer'

class OTPLoginUser extends Component {
    constructor(props) {
        super(props);
        this.state = {
            lblSalesHariini: '',
    ...
    RequestOTPAgain = () => {
        fetch(Link_generateOTP, {
            ...
            body: JSON.stringify({
                ...
                "NamaLengkap": this.state.namaCust,
                "Email": this.state.emailCust
            })
        })
    ...
    GenerateOTP = () => {
        fetch(Link_generateOTP, {
            ...
            "CustomerId": this.props.customerId,
                ...
                // "KodeTransaksi": this.props.paymentId
            })
        })
            .then(response => response.json())
            .then(
               ...
               <Text style={{color:'black',fontSize:17}}>
                   {this.props.customerId}
                        ...
                        <Text style={{ color: 'black', fontSize: 17, textAlign: 'center' }}>
                            Please Input 4 Digit OTP Code From Your Email To Activate Your Account
               </Text>
                        {/* <Text style={{ color: 'black', fontSize: 17, textAlign: 'center' }}>
                           "CustomerId":{ this.props.customerId},
                "NamaLengkap": {this.state.namaCust},
...
export default connect(mapStateToProps, mapDispatchToProps)(OTPLoginUser)