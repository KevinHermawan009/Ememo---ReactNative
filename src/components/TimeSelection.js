...
const link_saveBook = 'https://fitaccessproject.herokuapp.com/api/FitAccess/SaveBooking'
 ...
 fetch(link_saveBook, {
    ...
    .then(res => {
        ...
        if (res.Message == "SUKSES") {
            ...
            this.props.setBookDateChoosen(this.state.date),
                this.props.setStartHourChoosen(this.state.startDate),
                this.props.setEndHourChoosen(this.state.endDate)
            this.props.setBookId(this.state.BookId)
            // alert("Masuk Service")
            Actions.Booking()
        } else {
            // alert("ASUKambing")
            ...
            return (
                <View style={styles.bcc1}>
                    <View style={{ width: ScreenWidth * 96 / 100, alignSelf: 'center', marginBottom: ScreenHeight * 1 / 100, flexDirection: 'row' }}>
                        ...
                        <Text style={{ marginLeft: ScreenWidth * 1 / 100 }}>Not Avaible</Text>
                        <View style={{
                            width: ScreenWidth * 5 / 100,
                            height: ScreenHeight * 2.5 / 100,
                        ...
                        <Text style={{ marginLeft: ScreenWidth * 1 / 100 }}>Avaible</Text>
                        <View style={{
                            width: ScreenWidth * 5 / 100,
                            height: ScreenHeight * 2.5 / 100,
                        ...
                        <Text style={{ marginLeft: ScreenWidth * 1 / 100 }}>Choosen</Text>
                    </View>

                    <View style={styles.dc1}>
                        <Text style={{ fontSize: 16, textAlign: "center", color: 'white', fontWeight: 'bold', top:ScreenHeight*0.5/100 }}>Choose Time</Text>
                    </View>
                    ...
                    <TouchableOpacity onPress={this.gotoBooking} style={{ backgroundColor: '#FF7314', borderRadius: 30, width: ScreenWidth * 40 / 100, height: ScreenHeight * 7/ 100, alignSelf: 'center', top: ScreenHeight * 18 / 100 }}>
                        <View style={{ backgroundColor: '#0064c2', borderRadius: 30, width: ScreenWidth * 50 / 100, height: ScreenHeight * 7 / 100, alignSelf: 'center', top: ScreenHeight * 0 / 100 }}>
                            <Text style={{ textAlign: 'center', top: ScreenHeight * 1.7 / 100, fontSizeL: 14, color: 'white', fontWeight:'bold' }}>
                                Book Now
                        </Text>
                        </View>
                    </TouchableOpacity>
            ...
            <View style={styles.bc2}>
                <View style={styles.bc21}>
                    <View style={styles.b1}>
                        <Text style={styles.txt133}>Field Name:
                ...
                {/* <View style={styles.bc21}>
                    <View style={styles.b1}>
                        <Text style={styles.txt133}>Spot Yang Di Pilih:</Text>

                    </View>
                    <View style={styles.b1}>
                        <Text style={styles.txt133}>{this.props.companyidchoosen}</Text>
                ...
                {/* <View style={styles.bc21}>
                    <View style={styles.b1}>
                        <Text style={styles.txt133}>Id Customer:</Text>

                    </View>
                    <View style={styles.b1}>
                        <Text style={styles.txt133}>{this.state.date}</Text>
                        <Text style={styles.txt133}>{this.state.selectedSpot}</Text>
                    </View>

                </View> */}
                {/* <View style={styles.bc21}>
                    <View style={styles.b1}>
                        <Text style={styles.txt133}>Nama Lengkap:</Text>

                    </View>
                    <View style={styles.b1}>
                        <Text style={styles.txt133}>{this.props.namaLengkap}</Text>
                        <Text style={styles.txt133}>{this.state.selectedSpot}</Text>
                    </View>
                ...
                {/* <View style={styles.bc21}>
                    ...
                    <View style={styles.b1}>
                        <Text style={styles.txt133}>Harga Per Jam:</Text>
                        <Text style={styles.txt133}>{this.state.selectedSpot}</Text>
                    </View>
                    <View style={styles.b1}>
