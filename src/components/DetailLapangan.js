...
class DetailLapangan extends Component {
        ...
        if (this.state.wifi == "Tersedia") {
            return (
                <View style={styles.iconst}>
                    ...
                    <Text style={{ top: ScreenHeight * 3.5 / 100, textAlign: 'center', fontSize: 12, color: 'black' }}> Wifi</Text>
                </View>
            )
        } else {
            return (
        ...
        if (this.state.ruangganti == "Tersedia") {
            return (
                <View style={styles.iconst}>
                    ...
                    <Text style={{ top: ScreenHeight * 3 / 100, textAlign: 'center', fontSize: 14, color: 'black' }}> Changing Room</Text>
                </View>
            )
        } else {
            return (
        ...
        if (this.state.mobil == "Tersedia") {
            return (
                <View style={styles.iconst}>
                    ...
                    <Text style={{ top: ScreenHeight * 3.5 / 100, textAlign: 'center', fontSize: 12, color: 'black' }}>Car Park</Text>
                </View>
            )
        } else {
            <View></View>
        ...
        if (this.state.motor == "Tersedia") {
            return (
                <View style={styles.iconst}>
                    ...
                    <Text style={{ top: ScreenHeight * 3 / 100, textAlign: 'center', fontSize: 12, color: 'black', width: ScreenWidth * 20 / 100, left: ScreenWidth * -2.5 / 100 }}> MotorCycle Park</Text>
                </View>
            )
        } else {
            return (
    ...
    taskToDoShow() {
        return (
            <View style={{ width: ScreenWidth, flex: 1, marginBottom: ScreenHeight * 4 / 100, backgroundColor: 'white' }}>
                <ScrollView >

                    <Image source={{ uri: this.state.companylogo }} style={styles.gambarlp} resizeMode="stretch" />
                            ...
                            <View
                                ...
                                <TouchableOpacity
                                    ...
                                    <View style={{ width: ScreenWidth * 10 / 100, borderRightWidth: 2, borderRightColor: 'white' }}>
                                        <Icon name="cart-plus" style={{ color: 'white', marginLeft: ScreenWidth * 1 / 100, marginTop: ScreenWidth * 1 / 100 }} size={25}
                                        />
                                    </View>

                                    <View style={{ width: ScreenWidth * 19 / 100, backgroundColor: 'transparent', marginLeft: ScreenWidth * 1 / 100, alignItems: 'center' }}>
            ...
            <View style={{
                ...
                <Header hasTabs style={{ backgroundColor: '#0064c2' }} Title="asd">
                    <Body style={{ marginLeft: 20 }}>
                        <Title style={{ color: 'white' }}>FitAccess Sport Information</Title>
                    </Body>
                </Header>
                <ScrollView>
                    {this.taskToDoShow()}
